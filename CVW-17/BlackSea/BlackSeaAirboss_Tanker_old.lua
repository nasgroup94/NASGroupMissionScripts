  ...
  :OnSpawnGroup(
    function (shell_41)
     ...
     -- sh41Beacon:AATACAN(59, "SDN", true) --edited by Circuit to get tacan working 05/01/22
      sh41Beacon:ActivateTACAN(59,"Y", "SDN", true)
    end
  )
  :SpawnScheduled(60,0)
...
shellSouth = SPAWN
  ...
  :OnSpawnGroup(
    function (shell_21)
      ...
      sh21Beacon:ActivateTACAN(63,"Y", "SDS", true)
    end
  )
  :SpawnScheduled(60,0)
...
texacoNorth = SPAWN
  ...
  :OnSpawnGroup(
    function (texaco_31)
      ...
      tx31Beacon:ActivateTACAN(61,"Y", "TBN", true)
    end
  )
  :SpawnScheduled(60,0)
...
texacoSouth = SPAWN
  ...
  :OnSpawnGroup(
    function (texaco_21)
      ...
      tx21Beacon:ActivateTACAN(67,"Y", "TBS", true)
    end
  )
  :SpawnScheduled(60,0)
...
texacoEast = SPAWN:
  ...
  :OnSpawnGroup(
    function (texaco_51)
     ...
     -- tx51Beacon:AATACAN(57, "TBE", true) --edited by circuit to get tacan working 05/01/22
      tx51Beacon:ActivateTACAN(57,"Y", "TBE", true)
    end
  )
  :SpawnScheduled(60,0)
  ...
  :OnSpawnGroup(
    function (shell_51)
      shell_51:CommandSetCallsign(3,7)
      shell_51:CommandSetFrequency(258)
    end
  )
  :SpawnScheduled(60,0)
