...
local mission_scripts_path =  "C:/NASGroup/NASGroupMissionScripts/CVW-17/Iraq/Test/"
...
AIRBOSSBASESOUNDFOLDER = common_scripts_path .. "sound/Airboss Soundfiles/" -- needed for the default pilot sound files used by ariboss
AIRBOSSLSORAYNOR = common_scripts_path .. "sound/Airboss Soundfiles/Airboss Soundpack LSO Raynor"
AIRBOSSMARSHALRAYNOR = common_scripts_path .. "sound/Airboss Soundfiles/Airboss Soundpack Marshal Raynor/"
AIRBOSSMARSHALGABRIELLA = common_scripts_path .."sound/Airboss Soundfiles/Airboss Soundpack Marshal Gabriella/"
RANGESOUNDFOLDER = "sound/Range Soundfiles/"
...
-- GOOGLE_CREDS = "C:/NASGroup/API-Keys/cvw7-tracking-11c8a6927776.json"
SRS_PATH = "C:/DCS-SimpleRadio-Standalone-2.0.8.5"
...
assert(loadfile(mission_scripts_path .. "IraqAirBossTanker.lua"))() -- carrier/tarawa AIRBOSS
assert(loadfile(mission_scripts_path .. "IraqChiefBlue.lua"))()


-- Set up MSRS (Moose SRS)
MSRS.LoadConfigFile(nil, mission_scripts_path, "msrs_config.lua") -- Note the "." here
