...
do
	...
	return ( contact:getHeightInFeetMSL() > 500 )
    end
...
--Falkland Island IADS Settings
        islandIADS:getSAMSiteByGroupName('SAM1-SA-10-1'):setHARMDetectionChance(50):addGoLiveConstraint('ignore-low-flying-contacts', goLiveConstraint)
        local SA15island = islandIADS:getSAMSiteByGroupName('SAM1-SA-15-Defensex3')
        islandIADS:getSAMSiteByGroupName('SAM1-SA-5-1'):addPointDefence(SA15island):setHARMDetectionChance(0):addGoLiveConstraint('ignore-low-flying-contacts', goLiveConstraint)
