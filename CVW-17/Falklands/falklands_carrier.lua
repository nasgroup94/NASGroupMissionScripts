...
-- RecoveryTanker:SetCallsign(CALLSIGN.Tanker.Arco, 6)
-- RecoveryTanker:SetTACAN(60, "AR6")
-- RecoveryTanker:__Start(480)

--Circuit edit to turn off KC-135 until main island is blue
-- local airbase = AIRBASE:FindByName("Mount Pleasant")
...
--     HighTankerS3_1 = RECOVERYTANKER:New(UNIT:FindByName("CVN73"), "CVN73_ARCO1")
--     HighTankerS3_1:SetTakeoffAir()
--     HighTankerS3_1:SetRadio(267)
--     HighTankerS3_1:SetAltitude(MISSION_TANKER_ALTS.Offgoing)
--     HighTankerS3_1:SetModex(704)
--     HighTankerS3_1:SetCallsign(CALLSIGN.Tanker.Arco, 7)
--     HighTankerS3_1:SetTACAN(67, "AR7")
--     HighTankerS3_1:__Start(60)

--     HighTankerS3_2 = RECOVERYTANKER:New(UNIT:FindByName("CVN73"), "CVN73_ARCO1")
--     HighTankerS3_2:SetTakeoffAir()
--     HighTankerS3_2:SetRadio(268)
--     HighTankerS3_2:SetAltitude(MISSION_TANKER_ALTS.Offgoing+1000)
--     HighTankerS3_2:SetModex(705)
--     HighTankerS3_2:SetCallsign(CALLSIGN.Tanker.Arco, 8)
--     HighTankerS3_2:SetTACAN(68, "AR8")
--     HighTankerS3_2:__Start(240)
-- end
...
function Washington:OnAfterLSOGrade(From, Event, To, playerData, grade)
...
Washington:SetLSORadio(265)
Washington:SetMarshalRadio(264)
...
function Tarawa:OnAfterRecoveryStart(Event, From, To, Case, Offset)
    env.info(string.format("Starting Recovery Case %d ops.", Case))
