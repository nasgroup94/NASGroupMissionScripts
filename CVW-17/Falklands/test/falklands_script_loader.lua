...
local mission_scripts_path = "D:/vnao/VNAO-Mission_Scripts/CVW-7/Falklands/test/"--debug.getinfo(1).source:match("@?(.*/)") -- gets the path of where this file is located
local common_scripts_path = "D:/vnao/VNAO-Mission_Scripts/Common/"
local moose_folder = "D:/vnao/VNAO-MOOSE_INCLUDE/Moose_Include_Static/"
local user_folder = os.getenv('USERPROFILE'):gsub("\\","/") .. "/"


-- GLOBALS
SERVER_LOCATION = user_folder .. "Saved Games/" .. DCSServerBotConfig.INSTANCE_NAME .. "/"
GOOGLE_CREDS = "D:/vnao/API-Keys/cvw7-tracking-11c8a6927776.json"
SRS_PATH = "D:/Program Files/DCS-SimpleRadio-Standalone"
...
assert(loadfile(mission_scripts_path .. "falklands_red_airwing.lua"))() -- Must be loaded after IADS
