...
-- Any reference to these values really needs to be removed from any of the mission.json scripts going forward, vnaonServerBot takes care of setting
-- the weather now.
MISSION_TANKER_ALTS = {}
...
TARGETSHEETSTRAFELOCATION = "C:/Users/vnaon/Saved Games/vnaon.test/Logs/strafesheets"
TARGETSHEETBOMBLOCATION = "C:/Users/vnaon/Saved Games/vnaon.test/Logs/bombsheets"
TRAPSHEETLOCATION = "C:\\Users\\vnaon\\Saved Games\\vnaon.test\\Logs\\trapsheets"
...
-- assert(loadfile("C:/VNAO/VNAO-Mission_Scripts/CVW-7/Test/testAirboss.lua"))()
-- assert(loadfile("C:/VNAO/VNAO-Mission_Scripts/CVW-7/test/scoring.lua"))()
...
assert(loadfile("C:/VNAO/VNAO-Mission_Scripts/CVW-7/Test/chief test/chief.lua"))()
