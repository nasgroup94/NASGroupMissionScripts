...
--------------------------------------------- CVN73 -------------------------------------------------------
-- S3
RecoveryTanker = RECOVERYTANKER:New(UNIT:FindByName("CVN-75 Lone Warrior"), "CVN75_ARCO1")
...
RescueHelo = RESCUEHELO:New(UNIT:FindByName("CVN-75 Lone Warrior"), "CVN75_RESCUEHELO")
...
Awacs = RECOVERYTANKER:New("CVN-75 Lone Warrior", "CVN75_FOCUS")
Awacs:SetAWACS()
...
LoneWarrior = AIRBOSS:New("CVN-75 Lone Warrior", "CVN-75")
...
function LoneWarrior:OnAfterLSOGrade(From, Event, To, playerData, grade)
...
LoneWarrior:Load()
LoneWarrior:SetTACAN(75, "X", "LNW")
LoneWarrior:SetICLS(15, "LNW")
LoneWarrior:SetLSORadio(305)
...
LoneWarrior:SetRadioRelayLSO("CVN75_LSORELAY")
LoneWarrior:SetRadioRelayMarshal("CVN75_MARSHALRELAY")
