...
AWCVN73 = AIRWING:New("CVN-75 Lone Warrior", "CVW-7 Airwing")
-- AWCVN73:SetAirboss(Washington)

-- Fleet Logistics Support Squadron 40 (VRC-40)
CVN73_VRC40 = SQUADRON:New("CVN75_VRC40", 4, "Fleet Logistics Support Squadron 40")
...
AWCVN73:NewPayload(GROUP:FindByName("CVN75_VRC40"), 4, {AUFTRAG.Type.ORBIT})


CVN73_VAQ140 = SQUADRON:New("CVN75_VAQ140", 4, "VAQ-140 Patriots")
    :AddMissionCapability({AUFTRAG.Type.ORBIT})
    :SetCallsign(CALLSIGN.Aircraft.Ascot, 1)
    :SetFuelLowThreshold(0.3)

AWCVN73:AddSquadron(CVN73_VAQ140)
AWCVN73:NewPayload(GROUP:FindByName("CVN75_VAQ140_L1"), 4, {AUFTRAG.Type.ORBIT})


-- CVN73_VFA103 = SQUADRON:New("CVN75_VFA103", 4, "VFA-103 Jolly Rogers")
...
-- AWCVN73:NewPayload(GROUP:FindByName("CVN75_VFA103_L1"), 4, {AUFTRAG.Type.CAP, AUFTRAG.Type.ESCORT, AUFTRAG.Type.INTERCEPT})
-- AWCVN73:NewPayload(GROUP:FindByName("CVN75_VFA103_L2"), 4, {AUFTRAG.Type.ANTISHIP})
-- AWCVN73:NewPayload(GROUP:FindByName("CVN75_VFA103_L3"), 4, {AUFTRAG.Type.SEAD})

CVN73_ARCO3 = SQUADRON:New("CVN75_ARCO3", 6, "VS-21 Fighting Redtails")
...
AWCVN73:NewPayload(GROUP:FindByName("CVN75_ARCO3"), 6, {AUFTRAG.Type.TANKER, AUFTRAG.Type.ORBIT})
...
local andersenSquadronParkingIDs = {
    ...
    Tanker = {77,78,79,80,81,82,83,95,97,98,99,100,101,102,103,104,105,106,107,108,125,126,127,128,129,130,131,132,133},
    Airlift = {40,41,42,43,44,45,46,47,59,60,61,62,63,64,65,66,67,68},
    Bomber = {84,85,86,87,88,89,90,91,92,93,94,96,109,110,111,112,113,114,115,116,117,118,119,120,121,122,123,124,195,196,197},
...
SQDN_PSVP8 = SQUADRON:New("SQDN_PSVP8", 4, "Patrol Sqdn 8")
    :AddMissionCapability({AUFTRAG.Type.ORBIT})
    :SetCallsign(CALLSIGN.Aircraft.Enfield, 4)
...
function  auftragLuxorTkrMPRS:OnAfterScheduled(From, Event, To)
    db('OnAfterStarted()')
    tankerSetup(self, CALLSIGN.Tanker.Texaco, 1, 29, "LXR", 369.5)
end
...
function  auftragRioTkrMPRS:OnAfterScheduled(From, Event, To)
    tankerSetup(self, CALLSIGN.Tanker.Texaco, 2, 92, "RIO", 236.275)
end
...
function  auftragMirageTkrMPRS:OnAfterScheduled(From, Event, To)
    tankerSetup(self, CALLSIGN.Tanker.Texaco, 3, 63, "MRG", 271.525)
end
