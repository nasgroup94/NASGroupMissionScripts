...
---------------------Radar Range -------------------
TacticalRadarMenu = MENU_MISSION:New("W-11B Radar Range",TacticalMainMenu)
local SHOOTEXGroup1
local SHOOTEXGroup2
local SHOOTEXGroup3
function SHOOTEX1()
  SHOOTEXGroup1 = FLIGHTGROUP:New("QF-4 group 1")
  SHOOTEXGroup1:Activate()
  MESSAGE:New("SHOOTEX GROUP ONE SPAWNED",15,Info):ToAll()
end
MENU_MISSION_COMMAND:New('SHOOTEX GROUP ONE', TacticalRadarMenu, SHOOTEX1)

function SHOOTEX2()
  SHOOTEXGroup2 = FLIGHTGROUP:New("QF-4 group 2")
  SHOOTEXGroup2:Activate()
  MESSAGE:New("SHOOTEX GROUP TWO SPAWNED",15,Info):ToAll()
end
MENU_MISSION_COMMAND:New('SHOOTEX GROUP TWO', TacticalRadarMenu, SHOOTEX2)

function SHOOTEX3()
  SHOOTEXGroup3 = FLIGHTGROUP:New("QF-4 group 3")
  SHOOTEXGroup3:Activate()
  MESSAGE:New("SHOOTEX GROUP THREE SPAWNED",15,Info):ToAll()
end
MENU_MISSION_COMMAND:New('SHOOTEX GROUP THREE', TacticalRadarMenu, SHOOTEX3)

function clearRange()
  if SHOOTEXGroup1:IsActive() then
    SHOOTEXGroup1:Deactivate()
  end
  if SHOOTEXGroup2:IsActive() then
    SHOOTEXGroup2:Deactivate()
  end
  if SHOOTEXGroup3:IsActive() then
    SHOOTEXGroup3:Deactivate()
  end
  MESSAGE:New("RANGE CLEARED",15,Info):ToAll()
end
MENU_MISSION_COMMAND:New('CLEAR RANGE', TacticalRadarMenu, clearRange)
...
local SFWTAAMiG29BVR_fg
local SFWTAAMiG25BVR_fg
local SFWTAAMiG23BVR_fg
local SFWTAAMiG21BVR_fg
local SFWTEagleBVR_fg
local SFWTFalconBVR_fg
local SFWTF5BVR_fg
local SFWTEagleWVR_fg
local SFWTFalconWVR_fg

function SFWTAAMiG29BVR()
  SFWTAAMiG29BVR_fg = FLIGHTGROUP:New("RedMiG29")
  SFWTAAMiG29BVR_fg:SetDefaultROE(ENUMS.ROE.OpenFireWeaponFree)
  SFWTAAMiG29BVR_fg:Activate()

  MESSAGE:New("MiG29 BVR 2 ship activated",15,Info):ToAll()
end

MENU_MISSION_COMMAND:New('MiG29 BVR', TacticalSFWTAAMenu, SFWTAAMiG29BVR)

function SFWTAAMiG25BVR()
  SFWTAAMiG25BVR_fg = FLIGHTGROUP:New("RedMiG25")
  SFWTAAMiG25BVR_fg:SetDefaultROE(ENUMS.ROE.OpenFireWeaponFree)
  SFWTAAMiG25BVR_fg:Activate()

  MESSAGE:New("MiG25 BVR 2 ship activated",15,Info):ToAll()
end

MENU_MISSION_COMMAND:New('MiG25 BVR', TacticalSFWTAAMenu, SFWTAAMiG25BVR)

function SFWTAAMiG21BVR()
  SFWTAAMiG21BVR_fg = FLIGHTGROUP:New("RedMiG21")
  SFWTAAMiG21BVR_fg:SetDefaultROE(ENUMS.ROE.OpenFireWeaponFree)
  SFWTAAMiG21BVR_fg:Activate()

  MESSAGE:New("MiG21 BVR 2 ship activated",15,Info):ToAll()
end
MENU_MISSION_COMMAND:New('MiG21 BVR', TacticalSFWTAAMenu, SFWTAAMiG21BVR)

function SFWTAAMiG23BVR()
  SFWTAAMiG23BVR_fg = FLIGHTGROUP:New("RedMiG23")
  SFWTAAMiG23BVR_fg:SetDefaultROE(ENUMS.ROE.OpenFireWeaponFree)
  SFWTAAMiG23BVR_fg:Activate()

  MESSAGE:New("MiG23 BVR 2 ship activated",15,Info):ToAll()
end
MENU_MISSION_COMMAND:New('MiG23 BVR', TacticalSFWTAAMenu, SFWTAAMiG23BVR)




function SFWTAAEagleBVR()
    SFWTEagleBVR_fg = FLIGHTGROUP:New("Uzi1")
...
function SFWTAAFalconBVR()
    SFWTFalconBVR_fg = FLIGHTGROUP:New("Lobo1")
...
function SFWTAAF5BVR()
    SFWTF5BVR_fg = FLIGHTGROUP:New("Springfield1")
    SFWTF5BVR_fg:SetDefaultROE(ENUMS.ROE.OpenFireWeaponFree)
    SFWTF5BVR_fg:Activate()

    MESSAGE:New("F5 BVR 2 ship activated",15,Info):ToAll()
end
MENU_MISSION_COMMAND:New('F5 BVR', TacticalSFWTAAMenu, SFWTAATomcatBVR)

function SFWTAAEagleWVR()
    SFWTEagleWVR_fg = FLIGHTGROUP:New("Uzi2")
...
function SFWTAAFalconWVR()
    SFWTFalconWVR_fg = FLIGHTGROUP:New("Lobo2")
...
function clearAARange()

  if SFWTAAMiG29BVR_fg:IsActive() then
    SFWTAAMiG29BVR_fg:Deactivate()
  end

  if SFWTAAMiG25BVR_fg:IsActive() then
    SFWTAAMiG25BVR_fg:Deactivate()
  end

  if SFWTAAMiG23BVR_fg:IsActive() then
    SFWTAAMiG23BVR_fg:Deactivate()
  end

  if SFWTAAMiG21BVR_fg:IsActive() then
    SFWTAAMiG21BVR_fg:Deactivate()
  end

  if SFWTEagleBVR_fg:IsActive() then
    SFWTEagleBVR_fg:Deactivate()
  end

  if SFWTFalconBVR_fg:IsActive() then
    SFWTFalconBVR_fg:Deactivate()
  end

  if SFWTF5BVR_fg:IsActive() then
    SFWTF5BVR_fg:Deactivate()
  end

  if SFWTEagleWVR_fg:IsActive() then
    SFWTEagleWVR_fg:Deactivate()
  end

  if SFWTFalconWVR_fg:IsActive() then
    SFWTFalconWVR_fg:Deactivate()
  end
  
end


MENU_MISSION_COMMAND:New('CLEAR RANGE', TacticalSFWTAAMenu, clearAARange)
