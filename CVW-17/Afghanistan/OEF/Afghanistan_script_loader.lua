...
local mission_scripts_path =  "C:/NASGroup/NASGroupMissionScripts/CVW-17/Afghanistan/OEF/"
...
assert(loadfile(mission_scripts_path .. "/Afghanistan_carrier.lua"))() -- carrier/tarawa AIRBOSS